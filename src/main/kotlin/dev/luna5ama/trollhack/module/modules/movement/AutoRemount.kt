...
internal object AutoRemount : Module(
    ...
    private val lonelyBoat by setting("Boats Without Passenger", true, ::boat)
    ...
    private fun isValidEntity(entity: Entity): Boolean {
        return (lonelyBoat && entity is EntityBoat && entity.passengers.isEmpty()) // Only consider empty boats if lonelyBoat is enabled
                || (boat && !lonelyBoat && entity is EntityBoat) // Consider all boats if boat is enabled and lonelyBoat is not enabled
